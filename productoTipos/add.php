<?php
    ...
    if (isset($_POST['confirm']) && $_POST['confirm'] == 1 ) {
        ...
        if (!$nombre) {
            ...
            if ($tipo) {
                $msg = 'El tipo de producto ya está registrado... intente con otro';
            }else{
                //registrar la region en la tabla producto_tipos
    ...
    <div class="container-fluid">
        ...
        <section>
            <div class="col-md-6 offset-md-3">
                <h2>Nuev Producto Tipo</h2>
                <!-- get => el envio del dato se hace via url del sistema
                post => el envio del dato se hace via interna -->

                <form action="" method="post">
                    <div class="row mb-3">
                        <label for="tipo" class="col-md-2 col-form-label">Producto Tipo <span class="text-danger"> * </span> </label>
                        <div class="col-md-10">
                            <input type="text" name="nombre" class="form-control" placeholder="Ingrese el nombre de la producto tipo">
